...
// ROUTES PAGE
// =========================
// Renders every active route from the shared store admin edits
// (getRoutes() in index.js) — this is the connection that was
// missing before: editing a route's price/status in admin-routes.html
...
if (routesGrid) {
    const routes = getRoutes().filter(r => r.status === "active");
