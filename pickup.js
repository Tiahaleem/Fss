...
// PICKUP CENTERS PAGE
// =========================
// Renders every active terminal, grouped by city, from the shared
// store admin edits (getTerminals() in index.js). Adding/removing a
// terminal in admin-pickup.html now actually changes this page.
...
if (pickupCentersSection) {
    const terminals = getTerminals().filter(t => t.status === "active");
